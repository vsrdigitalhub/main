    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(default='cube', help_text='Name of the icon rendered in the service card.', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_customer', models.BooleanField(default=True, help_text='Marks this account as a VSR Digital Hub customer.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'New'), ('in_review', 'In review'), ('in_progress', 'In progress'), ('completed', 'Completed')], default='new', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
